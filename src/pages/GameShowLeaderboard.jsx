...
export default function GameShowLeaderboard() {
...
//   ];
  ...
  useEffect(() => {
    ...
    return (
    <div className="GameShowLeaderboardWrapper">
        <LeaderboardContainer heading="Game Show Leaderboard" leaders={leaders} top10={top10}/>
    </div>)
}